    ...
    <div inert={menuOpen ? undefined : ''} aria-hidden={!menuOpen} style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
          <a href="https://www.linkedin.com/in/akash-a-benki/" target="_blank" rel="noreferrer" title="LinkedIn" tabIndex={tabIdx} className="gc-social-btn" style={{ width: 44, height: 44, borderRadius: 13, background: 'rgba(255,255,255,.05)', border: '1px solid rgba(242,227,198,.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(242,227,198,.8)' }}>
          ...
          <a href="https://x.com/The_Sky_Fire" target="_blank" rel="noreferrer" title="Twitter / X" tabIndex={tabIdx} className="gc-social-btn" style={{ width: 44, height: 44, borderRadius: 13, background: 'rgba(255,255,255,.05)', border: '1px solid rgba(242,227,198,.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(242,227,198,.8)' }}>
          ...
          <a href="https://github.com/AAB007209/ganesh-chaturthi-live" target="_blank" rel="noreferrer" title="GitHub" tabIndex={tabIdx} className="gc-social-btn" style={{ width: 44, height: 44, borderRadius: 13, background: 'rgba(255,255,255,.05)', border: '1px solid rgba(242,227,198,.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(242,227,198,.8)' }}>
