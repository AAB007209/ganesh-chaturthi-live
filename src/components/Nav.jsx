...
export default function Nav() {
  const { navX, closeMenu, page, goHome, goMusic, goStory, goAbout } = useApp();
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
          <a href="#" title="Twitter / X" className="gc-social-btn" style={{ width: 44, height: 44, borderRadius: 13, background: 'rgba(255,255,255,.05)', border: '1px solid rgba(242,227,198,.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(242,227,198,.8)' }}>
            <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M18.24 2.25h3.31l-7.23 8.26 8.5 11.24h-6.63l-5.2-6.8-5.95 6.8H1.72l7.5-8.57L1.07 2.25h6.8l4.71 6.23zm-1.16 17.52h1.83L5.68 4.13H3.71z" /></svg>
          </a>
          <a href="#" title="LinkedIn" className="gc-social-btn" style={{ width: 44, height: 44, borderRadius: 13, background: 'rgba(255,255,255,.05)', border: '1px solid rgba(242,227,198,.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(242,227,198,.8)' }}>
          ...
          <a href="#" title="GitHub" className="gc-social-btn" style={{ width: 44, height: 44, borderRadius: 13, background: 'rgba(255,255,255,.05)', border: '1px solid rgba(242,227,198,.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(242,227,198,.8)' }}>
